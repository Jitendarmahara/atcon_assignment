      ...
      <div className="relative w-full max-w-sm animate-fade-up">
        ...
        <form onSubmit={onSubmit} className="card space-y-4 p-8">
          <div className="text-center">
            <h1 className="text-xl font-semibold text-slate-900">Track your application</h1>
            <p className="mt-1 text-sm text-slate-500">Sign in to see where you stand</p>
          </div>
          ...
          <div className="flex items-center justify-between text-xs">
            ...
            <Link to="/candidate/register" className="link-muted font-medium">
              Create an account
            </Link>
          </div>
        </form>
